                            ...
                            ? InkWell(
                                onTap: () {
                                  ...
                                  if (!Get.find<SearchGetController>().isStore) {
                                    for (var product
                                        in Get.find<SearchGetController>()
                                            .allItemList!) {
                                  ...
                                  Get.dialog(FilterWidget(
                                      maxValue: maxValue,
                                      isStore: Get.find<SearchGetController>()
                                          .isStore));
                                },
      ...
      Expanded(
        ...
        onNotification: (dynamic scrollNotification) {
          if (scrollNotification is ScrollEndNotification) {
            Get.find<SearchGetController>().setStore(true);
            Get.find<SearchGetController>().searchData(widget.searchText, false);
          }
          return false;
        },
        child:  ItemView(isItem: true),
      )
      ),
    ]);
  }
