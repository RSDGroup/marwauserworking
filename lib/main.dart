...
import 'package:sixam_mart/controller/auto_refresh_cntroller.dart';
...
Future<void> main() async {
  ...
  Get.put(CursorTimeoutController());
...
class _MyAppState extends State<MyApp> {
  ...
  void initState() {
    super.initState();
    cursorTimeoutController.startTimer();
    _route();
  }
  ...
  bool isMobileResponsive(BuildContext context) {
