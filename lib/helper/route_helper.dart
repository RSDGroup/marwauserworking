...
class RouteHelper {
  ...
  static String getPaymentRoute(String id, int? user, String? type, double amount, bool? codDelivery,String paymentmethod) => '$payment?id=$id&user=$user&type=$type&amount=$amount&cod-delivery=$codDelivery&payment-method=$paymentmethod';
  ...
  static List<GetPage> routes = [
    ...
    GetPage(name: payment, page: () => getRoute(PaymentScreen(orderModel: OrderModel(
        ...
        isCashOnDelivery: Get.parameters['cod-delivery'] == 'true' ? true : false ,paymentMethod: Get.parameters['payment-method']!,),
    )),
  ...
  static getRoute(Widget? navigateTo) {
    ...
    return AppConstants.appVersion < minimumVersion! ? const UpdateScreen(isUpdate: false)
