...
class OrderController extends GetxController implements GetxService {
  ...
  Future<ResponseModel?> stripecheck(PlaceOrderBody placeOrderBody, int? zoneID, double amount, double? maximumCodOrderAmount) async {
    _isLoading = true;
    update();
    Response response = await orderRepo.stripecheck(placeOrderBody, _orderAttachment);
    _isLoading = false;
