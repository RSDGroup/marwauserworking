...
class AppConstants {
  static const String appName = 'Marwa';
  static const double appVersion = 2.0;

  static const String baseUrl = "https://panel.marwa.hu";
  ...
  static const String CheckStripeUri = '/api/v1/customer/order/stripecheck';
  ...
  static List<LanguageModel> languages = [
    LanguageModel(imageUrl: Images.english, languageName: 'Hungarian', countryCode: 'HU', languageCode: 'hu'),
    LanguageModel(imageUrl: Images.arabic, languageName: 'English', countryCode: 'US', languageCode: 'en'),
